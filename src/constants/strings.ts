...
// export const GAME_URL = 'https://coredletwo.vercel.app'
export const GAME_URL = 'https://coredletwo.kuyachi.xyz'
...
export const WITH_WORDS_TEXT = 'w/ Terms'
...
export const MIGRATE_DESCRIPTION_TEXT =
  'Click here to transfer your CoredleTwo statistics to a new device.'
...
export const HOW_TO5B_TEXT =
  'Please refresh the page every Monday @ 3PM EST to ensure your daily terms are properly synced.'
